...
export function EnableSessionTanParamsChallengeResponseSpecificsFromJSON(json) {
    return EnableSessionTanParamsChallengeResponseSpecificsFromJSONTyped(json, false);
}
export function EnableSessionTanParamsChallengeResponseSpecificsFromJSONTyped(json, ignoreDiscriminator) {
...
export function EnableSessionTanParamsChallengeResponseSpecificsToJSONRecursive(value, ignoreParent = false) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function EnableSessionTanParamsChallengeResponseSpecificsToJSON(value) {
