...
export function OrderValidityTypeFromJSON(json) {
    return OrderValidityTypeFromJSONTyped(json, false);
}
export function OrderValidityTypeFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function OrderValidityTypeToJSON(value) {
    return value;
}
