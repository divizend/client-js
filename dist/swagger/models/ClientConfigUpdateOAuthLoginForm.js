...
export function ClientConfigUpdateOAuthLoginFormFromJSON(json) {
    return ClientConfigUpdateOAuthLoginFormFromJSONTyped(json, false);
}
export function ClientConfigUpdateOAuthLoginFormFromJSONTyped(json, ignoreDiscriminator) {
...
export function ClientConfigUpdateOAuthLoginFormToJSONRecursive(value, ignoreParent = false) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function ClientConfigUpdateOAuthLoginFormToJSON(value) {
