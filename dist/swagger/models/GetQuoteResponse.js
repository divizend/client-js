...
import { OrderCostEstimationFromJSON, OrderCostEstimationToJSON, } from "./OrderCostEstimation";
import { QuoteExpirationFromJSON, QuoteExpirationToJSON, } from "./QuoteExpiration";
export function GetQuoteResponseFromJSON(json) {
    return GetQuoteResponseFromJSONTyped(json, false);
}
export function GetQuoteResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function GetQuoteResponseToJSONRecursive(value, ignoreParent = false) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function GetQuoteResponseToJSON(value) {
