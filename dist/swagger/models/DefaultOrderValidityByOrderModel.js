...
export function DefaultOrderValidityByOrderModelFromJSON(json) {
    return DefaultOrderValidityByOrderModelFromJSONTyped(json, false);
}
export function DefaultOrderValidityByOrderModelFromJSONTyped(json, ignoreDiscriminator) {
...
export function DefaultOrderValidityByOrderModelToJSONRecursive(value, ignoreParent = false) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
export function DefaultOrderValidityByOrderModelToJSON(value) {
