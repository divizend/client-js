...
export class UserApi extends runtime.BaseAPI {
    ...
    async createAccessTokenRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateAccessTokenParamsToJSON(requestParameters.createAccessTokenParams),
        }, initOverrides);
        return new runtime.JSONApiResponse(response, (jsonValue) => AccessTokenResultFromJSON(jsonValue));
    }
    /**
     * Create a token for the current user. The token can be used to access resources on behalf of the user.
     */
    ...
    async getAccessTokensRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAccessTokensResponseFromJSON(jsonValue));
    }
    /**
     */
    ...
    async getAcessTokenAvailablePermissionsRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAcessTokenAvailablePermissions200ResponseFromJSON(jsonValue));
    }
    /**
     * Figure out which permissions are available to select from for a new access token.
     */
