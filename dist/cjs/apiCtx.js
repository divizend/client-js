...
exports.createAuth = exports.createConfiguration = void 0;
...
function createConfiguration(cfg) {
    if (!cfg.clientId) {
        throw new Error("You must configure a clientId to use the brokerize API.");
    }
    return new swagger_1.Configuration({
        fetchApi: cfg.fetch,
        basePath: cfg.basePath,
    });
}
exports.createConfiguration = createConfiguration;
function createAuth({ authCfg, cfg, options, tokenRefreshCallback, }) {
    var _a;
            ...
            async getToken() {
                if (guestAuthCfg.tokens) {
                    ...
                    if (needsRefresh && guestAuthCfg.tokens.response.refreshToken) {
                        ...
                        if (!response.ok) {
                            throw new _1.BrokerizeError(401, {
