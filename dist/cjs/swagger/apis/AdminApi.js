...
exports.GetOrderReportFormatEnum = exports.AdminApi = void 0;
...
class AdminApi extends runtime.BaseAPI {
    ...
    async addOAuthReturnToUrlRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            body: (0, models_1.AddOAuthReturnToUrlRequestToJSON)(requestParameters.addOAuthReturnToUrlRequest),
        }, initOverrides);
    ...
    async addOriginRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, models_1.AddOriginRequestToJSON)(requestParameters.addOriginRequest),
        }, initOverrides);
        return new runtime.VoidApiResponse(response);
    }
    /**
    ...
    async createClientRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CreateClient200ResponseFromJSON)(jsonValue));
    }
    /**
     * Create an API client.
     */
    ...
    async getMyClientsRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.ClientsResponseInnerFromJSON));
    }
    /**
     * List all clients that the current user may administrate.
     */
    ...
    async setClientConfigRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, models_1.SetClientConfigRequestToJSON)(requestParameters.setClientConfigRequest),
        }, initOverrides);
        return new runtime.VoidApiResponse(response);
    }
    /**
 ...
 * @export
 */
exports.GetOrderReportFormatEnum = {
    Csv: "csv",
    Xlsx: "xlsx",
    Json: "json",
};
