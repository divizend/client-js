 ...
 * @export
 */
export declare const AuthMethodTanFlowEnum: {
    readonly Tan: "TAN";
};
export type AuthMethodTanFlowEnum = (typeof AuthMethodTanFlowEnum)[keyof typeof AuthMethodTanFlowEnum];
export declare function AuthMethodTanFromJSON(json: any): AuthMethodTan;
export declare function AuthMethodTanFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthMethodTan;
export declare function AuthMethodTanToJSONRecursive(value?: AuthMethodTan | null, ignoreParent?: boolean): any;
export declare function AuthMethodTanToJSON(value?: AuthMethodTan | null): any;
