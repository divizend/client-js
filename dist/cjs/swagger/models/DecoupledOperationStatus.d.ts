 ...
 */
import { DecoupledOperationState } from "./DecoupledOperationState";
/**
 *
 * @export
...
export declare function DecoupledOperationStatusFromJSON(json: any): DecoupledOperationStatus;
export declare function DecoupledOperationStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): DecoupledOperationStatus;
export declare function DecoupledOperationStatusToJSONRecursive(value?: DecoupledOperationStatus | null, ignoreParent?: boolean): any;
export declare function DecoupledOperationStatusToJSON(value?: DecoupledOperationStatus | null): any;
