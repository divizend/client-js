...
exports.getWebSocketURLByBasePath = exports.AuthorizedApiContext = void 0;
...
class AuthorizedApiContext {
    constructor(cfg, auth, wsClient) {
        ...
        this._auth = auth;
        this._childContexts = [];
        const apiConfig = (0, apiCtx_1.createConfiguration)(cfg);
        ...
        const apiConfigCryptoService = (0, apiCtx_1.createConfiguration)(cfgCryptoService);
        this._logoutSubject = new rxjs_1.Subject();
        const postMiddleware = async (r) => {
            const statusCode = r.response.status;
            if (statusCode >= 400) {
                const decJson = (await r.response.json());
                const err = new errors_1.BrokerizeError(statusCode, decJson);
                if (statusCode == 401) {
    ...
    subscribeQuotes(securityQuotesToken, callback) {
        return (0, pollingSubscription_1.createPollingSubscription)(() => this.getSecurityQuotes({ securityQuotesToken }), 2500, callback);
    }
    /**
    ...
    subscribeAvailableOrderIntents(preparedTrade, callback) {
        ...
        if (preparedTrade.availableOrderIntentsToken) {
            ...
            return (0, pollingSubscription_1.createPollingSubscription)(async () => {
    ...
    _initInternalWebSocketClient() {
        ...
        return new websocketClient_1.BrokerizeWebSocketClientImpl(websocketPath, this._auth, this._cfg.createWebSocket);
    }
...
exports.AuthorizedApiContext = AuthorizedApiContext;
...
exports.getWebSocketURLByBasePath = getWebSocketURLByBasePath;
