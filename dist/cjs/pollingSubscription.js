...
exports.createPollingSubscription = void 0;
/**
 ...
 */
function createPollingSubscription(fetchData, intvlMs, callback) {
    let timeout = null;
    let done = false;
    function doCallback(err, data) {
        ...
        try {
            ...
            console.error("brokerize pollingSubscription: the user callback threw an error unexpectedly: ", err);
        }
        if (err) {
...
exports.createPollingSubscription = createPollingSubscription;
